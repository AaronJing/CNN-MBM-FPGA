...
HD_PWD='F:/project/lenet-5/lenet-5/lenet-5.runs/lenet_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lenet_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lenet_rst_ps7_0_100M_0.tcl
