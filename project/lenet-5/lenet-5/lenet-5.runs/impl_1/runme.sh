...
HD_PWD='F:/project/lenet-5/lenet-5/lenet-5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lenet_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lenet_wrapper.tcl -notrace
