...
HD_PWD='F:/project/lenet-5/lenet-5/lenet-5.runs/lenet_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lenet_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lenet_auto_pc_0.tcl
