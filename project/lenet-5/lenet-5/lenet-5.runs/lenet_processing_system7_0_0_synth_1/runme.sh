...
HD_PWD='F:/project/lenet-5/lenet-5/lenet-5.runs/lenet_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lenet_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lenet_processing_system7_0_0.tcl
