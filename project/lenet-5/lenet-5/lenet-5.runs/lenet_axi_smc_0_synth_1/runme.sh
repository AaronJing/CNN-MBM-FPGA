...
HD_PWD='F:/project/lenet-5/lenet-5/lenet-5.runs/lenet_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lenet_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lenet_axi_smc_0.tcl
