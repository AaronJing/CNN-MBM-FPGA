...
void POOL_LAYER_1(float* input, float* kernel, float* bias, float* output, int scale){
	int row, col, depth;
	float temp;
...
void POOL_LAYER_2(float* input, float* kernel, float* bias, float* output, int scale){
	int row, col,  depth;
	float temp;
